...
Latest frontend gate recheck after the approval e2e, updater-verifier, and release-doc verifier updates:

```bash
pnpm check:pi-boundary # approval boundary, no-Pi-sidecar (1010 tracked files), surface isolation, invoke, and release-doc audits pass
...
pnpm test # 180 files, 1030 tests
pnpm test:coverage # 180 files, 1030 tests; coverage report generated
