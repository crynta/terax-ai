  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "after:absolute after:bg-ring after:opacity-0 after:transition-opacity group-data-horizontal/tabs:after:left-2 group-data-horizontal/tabs:after:right-[0.3125rem] group-data-horizontal/tabs:after:bottom-[-5px] group-data-horizontal/tabs:after:h-px group-data-vertical/tabs:after:inset-y-0 group-data-vertical/tabs:after:-right-1 group-data-vertical/tabs:after:w-px group-data-[variant=line]/tabs-list:data-active:after:opacity-100",
        className
      )}
      {...props}
    />
