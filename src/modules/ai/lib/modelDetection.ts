...
export function detectFromUrl(url: string): DetectedProvider | null {
  ...
  ["api.minimaxi.chat", "moonshot", 0.7],
  ...
  ["api-inference.huggingface.co", "huggingface", 0.99],
    ["dashscope.aliyuncs.com", "moonshot", 0.5],
    ["localhost:11434", "ollama", 0.99],
    ["localhost:1234", "lmstudio", 0.99],
    ["cerebras.ai", "cerebras", 0.99],
    ["api.groq.com", "groq", 0.99],
    ["api.siliconflow.cn", "openai-compatible", 0.7],
    ["api.novita.ai", "openai-compatible", 0.7],
    ["api.deepinfra.com", "openai-compatible", 0.7],
  ];
