...
export const MODELS = [
  ...
  },
  {
    ...
    label: "GLM-5",
    hint: "Value",
    description: "Previous-gen GLM at lower cost via OpenCode Go.",
  ...
  },
  {
    ...
    label: "Kimi K2.5",
    hint: "Cheap",
    description: "Budget-friendly coding via OpenCode Go.",
    capabilities: { intelligence: 4, speed: 3, cost: 4 },
    tags: ["tools", "coding"],
  },
  {
  ...
  },
  {
    ...
    label: "MiMo V2.5",
    hint: "Ultrafast",
    description: "Extremely fast and cheap via OpenCode Go.",
    capabilities: { intelligence: 3, speed: 5, cost: 5 },
    tags: ["tools"],
  },
  {
    ...
    label: "MiMo V2.5 Pro",
    hint: "Fast",
    description: "Fast with higher quality via OpenCode Go.",
    capabilities: { intelligence: 4, speed: 4, cost: 3 },
    tags: ["tools", "coding"],
  },
  {
    ...
    label: "MiniMax M3",
    hint: "Balanced",
    description: "Balanced open model via OpenCode Go.",
    capabilities: { intelligence: 4, speed: 3, cost: 3 },
    tags: ["tools", "coding"],
  },
  {
    ...
    label: "MiniMax M2.7",
    hint: "Value",
    description: "Good value balanced model via OpenCode Go.",
  ...
  },
  {
    ...
    label: "MiniMax M2.5",
    hint: "Cheap",
    description: "Budget-friendly via OpenCode Go.",
    capabilities: { intelligence: 3, speed: 4, cost: 5 },
    tags: ["tools"],
  },
  {
    ...
    label: "Qwen3.7 Max",
    hint: "Quality",
    description: "High-intelligence model via OpenCode Go.",
    capabilities: { intelligence: 5, speed: 2, cost: 2 },
    tags: ["reasoning", "tools", "coding"],
  },
  {
    ...
    label: "Qwen3.6 Plus",
    hint: "Balanced",
    description: "Balanced quality and cost via OpenCode Go.",
    capabilities: { intelligence: 4, speed: 3, cost: 3 },
    tags: ["tools", "coding"],
  },
  {
    ...
    label: "Qwen3.5 Plus",
    hint: "Value",
    description: "Budget-friendly Qwen via OpenCode Go.",
    capabilities: { intelligence: 3, speed: 4, cost: 4 },
    tags: ["tools"],
  },
  {
    ...
    label: "MiMo V2 Pro",
    hint: "Fast",
    description: "Fast autonomous model via OpenCode Go.",
    capabilities: { intelligence: 4, speed: 4, cost: 3 },
    tags: ["tools", "coding"],
  },
  {
    ...
    label: "MiMo V2 Omni",
    hint: "Balanced",
    description: "Versatile MiMo model via OpenCode Go.",
    capabilities: { intelligence: 3, speed: 4, cost: 4 },
    tags: ["tools"],
  },
  {
    ...
    label: "Hy3 Preview",
    hint: "Reasoning",
    description: "Tencent Hunyuan 3, 295B MoE reasoning model via OpenCode Go.",
    capabilities: { intelligence: 5, speed: 2, cost: 2 },
    tags: ["reasoning", "tools", "coding"],
  },
...
export const MODEL_CONTEXT_LIMITS: Record<string, number> = {
  ...
  "opencode-go/glm-5.1": 128_000,
  "opencode-go/glm-5": 128_000,
  "opencode-go/kimi-k2.6": 131_072,
  "opencode-go/kimi-k2.5": 131_072,
  "opencode-go/deepseek-v4-pro": 128_000,
  "opencode-go/deepseek-v4-flash": 128_000,
  "opencode-go/mimo-v2.5": 128_000,
  "opencode-go/mimo-v2.5-pro": 128_000,
  "opencode-go/minimax-m3": 1_000_000,
  "opencode-go/minimax-m2.7": 1_000_000,
  "opencode-go/minimax-m2.5": 1_000_000,
  "opencode-go/qwen3.7-max": 131_072,
  "opencode-go/qwen3.6-plus": 131_072,
  "opencode-go/qwen3.5-plus": 131_072,
  "opencode-go/mimo-v2-pro": 128_000,
  "opencode-go/mimo-v2-omni": 128_000,
  "opencode-go/hy3-preview": 256_000,
...
export const MODEL_PRICING: Record<string, ModelPricing> = {
  ...
  "opencode-go/glm-5": { input: 1.0, output: 3.2, cacheRead: 0.2 },
  "opencode-go/kimi-k2.6": { input: 0.95, output: 4.0, cacheRead: 0.16 },
  "opencode-go/kimi-k2.5": { input: 0.6, output: 3.0, cacheRead: 0.1 },
  ...
  "opencode-go/minimax-m3": { input: 0.6, output: 2.4, cacheRead: 0.12 },
  "opencode-go/minimax-m2.7": { input: 0.3, output: 1.2, cacheRead: 0.06 },
  "opencode-go/minimax-m2.5": { input: 0.3, output: 1.2, cacheRead: 0.06 },
  "opencode-go/qwen3.7-max": { input: 2.5, output: 7.5, cacheRead: 0.5 },
  "opencode-go/qwen3.6-plus": { input: 0.5, output: 3.0, cacheRead: 0.05 },
};
