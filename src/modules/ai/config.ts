...
export const PROVIDERS: readonly ProviderInfo[] = [
  ...
  },
  {
    ...
    keyringAccount: "",
    keyPrefix: null,
    consoleUrl: "https://docs.ollama.com/api/openai-compatibility",
  },
  {
    id: "zai",
    label: "Z.AI",
...
export const KEYLESS_PROVIDERS: readonly ProviderId[] = ["lmstudio", "ollama"] as const;
...
export type AutocompleteProviderId = "cerebras" | "groq" | "lmstudio" | "ollama";
