  ...
  function ExplorerSearch(
    ...
    return (
      <div className="flex flex-col">
        {open ? (
          <div className="relative shrink-0 px-2 py-1.5 animate-in fade-in-0 slide-in-from-top-3 duration-[calc(200ms*var(--terax-anim,1))] ease-out">
            <HugeiconsIcon
              icon={Search01Icon}
              size={13}
              strokeWidth={2}
            ...
            />
            {!query && shortcutText ? (
              <KbdChip className="pointer-events-none absolute top-1/2 right-3.5 -translate-y-1/2">
                {shortcutText}
              </KbdChip>
            ) : null}
            {query ? (
